  ...
  const projects = [
    {
      ...
      description: "Site vitrine d'exception, immersif et fluide, conçu pour des chambres d'hôtes de prestige dans les Alpes suisses.",
      image: "https://images.unsplash.com/photo-1502784444187-359ac186c5bb?auto=format&fit=crop&w=800&q=80",
      link: "#",
    },
    {
      title: "Atelier du Pain",
      location: "Bruxelles, Belgique",
      category: "Commerce Local",
      description: "Plateforme e-commerce locale et système de click & collect élégant pour une boulangerie-pâtisserie artisanale.",
      image: "https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=800&q=80",
      link: "#",
    },
    {
      title: "Cabinet Vasseur",
      location: "Paris, France",
      category: "Artisanat d'Art & Design",
      description: "Présentation de catalogue minimaliste, rapide et éditoriale mettant en valeur les réalisations d'un cabinet d'architecture.",
